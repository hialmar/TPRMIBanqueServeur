...
public class BanqueSimple {
	...
	public synchronized void ajouterNotification(String id, Notification notification)
			throws NotificationPresente {
		CompteEnBanque cpt = comptes.get(id);
		if (cpt.getNotification() != null) {
			throw new NotificationPresente();
		}
		cpt.setNotification(notification);
	}
