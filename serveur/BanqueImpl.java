...
public class BanqueImpl extends UnicastRemoteObject implements Banque {
	 ...
	 */
	@Override
	public void ajouterNotification(String id, Notification notification)
			throws RemoteException, CompteInexistant, NotificationPresente {
		if(!banque.compteExiste(id)) {
			throw new CompteInexistant();
		}
		banque.ajouterNotification(id, notification);
